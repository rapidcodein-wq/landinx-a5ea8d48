...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "X Studio — Premium Agency for Creatives" },
      { name: "description", content: "X Studio is a premium creative agency crafting unique digital presences that help ambitious brands grow and stand out." },
      { name: "author", content: "X Studio" },
      { property: "og:title", content: "X Studio — Premium Agency for Creatives" },
      { property: "og:description", content: "X Studio is a premium creative agency crafting unique digital presences that help ambitious brands grow and stand out." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "X Studio — Premium Agency for Creatives" },
      { name: "twitter:description", content: "X Studio is a premium creative agency crafting unique digital presences that help ambitious brands grow and stand out." },
