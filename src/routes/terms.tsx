...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms & Conditions — X Studio" },
      { name: "description", content: "The terms and conditions that govern your use of the X Studio website and services." },
      { property: "og:title", content: "Terms & Conditions — X Studio" },
      { property: "og:description", content: "Terms and conditions for using X Studio services." },
    ],
  }),
  component: TermsPage,
});
        ...
        <article className="mx-auto max-w-3xl">
          ...
          <div className="prose-xstudio mt-10 space-y-8 text-foreground/80">
            <section>
              ...
              <p className="mt-3">By engaging X Studio (&quot;we&quot;, &quot;us&quot;) for services, you agree to these terms. If you don't agree, please don't use our services.</p>
            </section>
            <section>
