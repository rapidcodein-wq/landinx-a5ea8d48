...
export const projects: Project[] = [
  ...
  { slug: "lens-social", name: "Lens Social Studio", client: "Lens Lifestyle", year: 2024, category: "Marketing", service: "Social Media Production", year: 2024 as number, img: socialCampaign, tags: ["Social", "Content", "Production"], description: "Monthly social content engine — 60 assets / month including reels, carousels and editorial photography.", results: ["+220% follower growth", "+84% engagement rate"] },
